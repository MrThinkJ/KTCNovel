...
<head>
    ...
    <link rel="stylesheet" href="/css/poster/manage-book.css"/>
...
<main>
    <div class="directory">Truyện đang làm</div>
    <div class="row">
        <c:forEach items="${bookList}" var="book">
            <div class="col-4">
                <div class="book">
                    <a href="/nguoi-dang/novel/${book.convert()}">
                        <div class="book-image">
                            <img src="${book.bookImage}" alt="" width="110px"/>
                        </div>
                    </a>
                    <div class="book-detail">
                        <a href="/nguoi-dang/novel/${book.convert()}">
                            <div class="book-name field">${book.bookName}</div>
                        </a>
                        <div class="book-description field">
                            ${book.bookDescription}
                        </div>
                        <div class="author-and-field">
                            <div class="book-author field">
                                <i class="fa-solid fa-user-pen" style="margin-right: 5px;"></i>${book.bookAuthor}
                            </div>
                            <div class="book-type field">${book.typeName}</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="/js/poster/manage-book.js"></script>
</body>
</html>