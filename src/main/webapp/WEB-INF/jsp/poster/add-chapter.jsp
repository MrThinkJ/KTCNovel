...
<main>
    <div class="directory">
        Đế Bá<i class="fa-solid fa-circle"></i>Thêm chương mới
    </div>
    <div class="add-chapter-form">
        <form action="/file" method="POST" id="add-form">
            ...
            <div class="field">
                ...
                <div class="file">
                    <input type="file" name="file" id="file" class="inputfile" accept=".txt"/>
                    <label for="file" class="fileLabel">Chọn file</label>
                    <p class="note">Lưu ý: Chỉ hỗ trợ định dạng file Text (.txt)</p>
                </div>
            </div>
