...
<main>
    <div class="directory">Chỉnh sửa<i class="fa-solid fa-circle"></i>${book.name}</div>
    <div class="add-book-form">
        <mvc:form modelAttribute="book" action="/nguoi-dang/novel/update/${book.name}/process" id="add-form" method="post">
            <div class="field">
                <label for="book-name">Tên truyện: </label>
                <div class="input">
                    <mvc:input type="text" class="book-name" id="book-name" placeholder="Tên của truyện" path="name"/>
                </div>
            </div>
            <div class="field">
                <label for="book-author">Tác giả: </label>
                <div class="input">
                    <mvc:input type="text" class="book-author" path="author" placeholder="Tác giả của truyện"/>
                </div>
            </div>
            <div class="field">
...
<script src="/js/poster/update-book.js"></script>
</body>
</html>