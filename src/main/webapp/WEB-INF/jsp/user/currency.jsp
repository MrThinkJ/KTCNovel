...
<link rel="icon" href="/images/page/logo.png" type="image/x-icon" />
    <link href="<c:url value="/css/user/currency.css" />" rel="stylesheet">
...
<c:set var="currentPage" value="${chapterPurchaseList.number}" />
<c:set var="numberOfPages" value="${chapterPurchaseList.totalPages}" />
<c:set var="chapterPurchaseList" value="${chapterPurchaseList.content}" />
<body>
        ...
        <div class="row user-head">
            <div class="col-3 left-col">
                ...
                <div class="option">
                    ...
                    <a href="/tai-khoan/nguyen-thach"><div class="row active"><i class="fa-solid fa-coins"></i>Nguyên thạch</div></a>
                ...
                <div class="body">
                    ...
                    <div class="currency-history">
                        <div class="history-head">
                            Lịch sử tiêu phí nguyên thạch
                        </div>
                        <div class="history-body">
                            <c:forEach items="${chapterPurchaseList}" var="chapterPurchase">
                                <div class="purchase">
                                    <div class="book-information">
                                        <div class="chapter-name">
                                            ${chapterPurchase.chapter.name}
                                        </div>
                                        <div class="book-name">
                                            Truyện: ${chapterPurchase.book.name}
                                        </div>
                                        <div class="purchase-date">
                                            Ngày mua: ${chapterPurchase.purchaseDate}
                                        </div>
                                    </div>
                                    <div class="cost">
                                        100 <img src="/images/page/currency.png" alt="" width="15px">
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
