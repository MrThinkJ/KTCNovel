...
<c:set var="currentPage" value="${bookPage.number}" />
<c:set var="numberOfPages" value="${bookPage.totalPages}" />
<body>
        ...
        <div class="row user-head">
            <div class="col-3 left-col">
                ...
                <div class="option">
                    ...
                    <a href="/tai-khoan/da-doc"><div class="row active"><i class="fa-solid fa-book"></i>Đã đọc</div></a>
            ...
            <div class="col-9 right-col">
                <div class="head-book">
                    <div class="book-read active">
                        Đã đọc
                    </div>
                </div>
                <div class="body-book">
                    <div class="body-book-read">
                        <c:forEach items="${bookReadList}" var="book">
                            <div class="book">
                                <div class="wrapper-book">
                                    <a href="/truyen/">
                                        <div class="book-image">
                                            <img src="${book.get(0).image}" alt="">
                                        </div>
                                    </a>
                                    <div class="book-information">
                                        <div class="book-name">
                                            <a href="">${book.get(0).name}</a>
                                        </div>
                                        <div class="book-read">
                                            <i class="fa-solid fa-eye"></i> Đã đọc: ${book.get(1)}
                                        </div>
                                    </div>
                                </div>
                                <div class="delete">
                    ...
                    <c:forEach var="page" begin="1" end="${numberOfPages}">
                        <c:choose>
                            <c:when test="${currentPage+1 == page}">
                                <a href="/tai-khoan/da-doc?page=${page}"><div class="page active">${page}</div></a>
                            </c:when>
                            <c:otherwise>
                                <a href="/tai-khoan/da-doc?page=${page}"><div class="page">${page}</div></a>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                </div>
